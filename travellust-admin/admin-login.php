				...
				<form action="admin-login.php" method="post" autocomplete="off">
					...
					<div class="row">
						<div class="col l12 m12">
							<button style="background:#FE435B;" class="btn col l12 m12 s12" name="login" type="submit">
...
<?php
	if(isset($_POST['login'])){
		...
		$pass = $_POST['password'];
		$query = "select * from admin_login where email='$email' && password='$pass'";
